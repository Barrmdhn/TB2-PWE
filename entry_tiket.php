		...
		<form action="inserttiket.php" method="POST">
			...
			<div class="input-group">
				...
				<select name="hari_berangkat" id="">
					<option value="0">-Pilih hari seminar-</option>
				...
				<input type="time" placeholder="Waktu_seminar" name="waktu_seminar">
			</div>
			<div class="input-group">
				<select name="no_tujuan" id="" style="width: 250px;">
					...
					while($rows=mysqli_fetch_array($hasil)){
						echo "<option value='". $rows['nama_seminar']."'>". $rows['nama_seminar']."</option>"; 
					}
					?>
				</select>
			</div>
